...
public class IndexRestMockTest {
    ...
    public void getDepartmentTest() throws Exception {
        ...
        given(this.departmentRestService.getDepartment(1)).willReturn(new DepartmentDTO(1, "인사팀", null)); // getDepartment 메소드에 인자값 1이 입력될 경우 .willReturn(getDepartment); // getDepartment 객체를 리턴한다.
